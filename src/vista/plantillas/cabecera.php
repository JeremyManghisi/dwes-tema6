    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          ?>
            <li class="nav-item">
              <a class="nav-link" href="index.php?controlador=usuario&accion=registro">Regístrate</a>
            </li>
            <li class="nav-item">
          ...
          if ($sesion->haySesion()) {
            ...
            ?>
            <li class="nav-item">
              <a class='nav-link' href='index.php?controlador=usuario&accion=logout'>
                Cerrar sesión (<?= $_SESSION['usuario']['nombre'] ?> <img src=<?= $avatar ?> width="30" height="30"> )
              </a>
            </li>
          <?php
          }
